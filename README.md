...
1) ([open in Colab](https://colab.research.google.com/github/HamedAlemo/eo-fm-tutorials/blob/main/flood_segmentation.ipynb)) Fine-tuning Prithvi EO 2.0 foundation model for flood mapping. This tutorial uses the Sen1Floods11 dataset. 
